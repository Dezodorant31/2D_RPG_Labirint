...
int unitsCount = 0;
int heroIndex = 0;//координаты игрока
...
//Функция MoveUnitTo работает для всех существ
