...
//Функция, возращающая имена оружия
...
//Функция, которая возващает урон оружия
...
//Функция, возращающая тип оружия соответствующий символу на уровне
